...
(function ($, undefined) {
    ...
    p.init = function (input, opts) {
        ...
        self.initPatches();
        self.initPlugins(self.opts(OPT_PLUGINS), $.fn.wdtextext.plugins);
    ...
    var textext = $.fn.wdtextext = function (opts) {
        var css;

        if (!cssInjected && (css = $.fn.wdtextext.css) != null) {
...
(function ($) {
    ...
    $.fn.wdtextext.TextExtIE9Patches = TextExtIE9Patches;
    $.fn.wdtextext.addPatch('ie9', TextExtIE9Patches);
