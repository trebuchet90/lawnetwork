...
add_action( 'gform_user_registered', 'set_user_type', 10, 3 );

function set_user_type( $user_id, $feed, $entry ) {
// get type from field 4 of the entry.

$member = rgar( $entry, '2');

if($member == 'Attorney') {

  $selected_type = 'attorney';

}

if($member == 'Law Student') {

  $selected_type = 'student';

}

if($member == 'Law Professional') {

  $selected_type = 'professional';

}

bp_set_member_type( $user_id, $selected_type );
